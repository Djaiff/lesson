...
subtitle: "Éléments d'introduction au développement d'une application web réactive avec R"
...
output:
  pdf_document:
    ...
    includes:
      ...
      before_body: prefix_body.tex
      
---

# Shiny : créer des applications web avec le logiciel R

Shiny \citep{shiny} [^fn_shiny] est un package qui permet la création simple d'applications web intéractives depuis le logiciel open-source __R__ \citep{rcore}. Il présente quelques intérêts non négligeables qui ont contribué à son succès et au soutien de la communauté:
...
Une application __shiny__ nécessite un ordinateur/un serveur exécutant une session __R__.

\begin{center}
  \includegraphics[width=\textwidth]{../Slides/img/server_R.png}
\end{center}
...
\begin{center}
  \includegraphics[width=12cm]{../Slides/img/run_app.png}
\end{center}
...
\begin{center}
  \includegraphics[width=12cm]{../Slides/img/stop.png}
\end{center}
...
\begin{figure}
  \centering
  \includegraphics[width=12cm]{../Slides/img/hello_shiny.png}
...
- Côté _ui_, on définit un curseur numérique avec le code `sliderInput(inputId = "bins",...)` et on utilise sa valeur côté _server_ avec la notation `input$bins`:  c'est comme cela que l'interface créé des variables disponibles dans le serveur !

- Côté _server_,  nous créons un graphique `output$distPlot <- renderPlot({...})` et l'appelons dans l' _ui_ avec `plotOutput(outputId = "distPlot")`: c'est comme cela que le serveur retourne des objets à l'interface !
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{../Slides/img/shiny_process.png}
...
1. xxInput(inputId = ..., ...): pour définir un élément qui permet une action de l'utilisateur, ce dernier sera accessible côté serveur via son identifiant `input$[inputID]`.

\begin{center}
  \includegraphics[width=10cm]{../Slides/img/xxInput.png}
\end{center}
...
\begin{center}
  \includegraphics[width=10cm]{../Slides/img/renderXX.png}
\end{center}
...
Les principaux éléments d'interface sont représentés ci-après. Dans la suite, on détaille successivement le fonctionnement de certains d'entres-eux.

\begin{center}
  \includegraphics[width=12cm]{../Slides/img/all_input.png}
\end{center}
...
\begin{center}
  \includegraphics[width=10cm]{../Slides/img/numeric.png}
\end{center}
...
\begin{center}
  \includegraphics[width=10cm]{../Slides/img/slider.png}
\end{center}
...
\begin{center}
  \includegraphics[width=10cm]{../Slides/img/multiple_slider.png}
\end{center}
...
\begin{center}
  \includegraphics[width=10cm]{../Slides/img/text.png}
\end{center}
...
\begin{center}
  \includegraphics[width=10cm]{../Slides/img/unique_select.png}
\end{center}
...
\begin{center}
  \includegraphics[width=10cm]{../Slides/img/logical.png}
\end{center}
...
\begin{center}
  \includegraphics[width=10cm]{../Slides/img/multiple_checkbox.png}
\end{center}
...
\begin{center}
  \includegraphics[width=10cm]{../Slides/img/radio.png}
\end{center}
...
\begin{center}
  \includegraphics[width=10cm]{../Slides/img/date.png}
\end{center}
...
\begin{center}
  \includegraphics[width=12cm]{../Slides/img/date_range.png}
\end{center}
...
\begin{center}
  \includegraphics[width=12cm]{../Slides/img/file.png}
\end{center}
...
\begin{center}
  \includegraphics[width=10cm]{../Slides/img/action.png}
\end{center}
...
\begin{center}
  \includegraphics[width=\textwidth]{../Slides/img/all_output.png}
\end{center}
...
\begin{center}
  \includegraphics[width=12cm]{../Slides/img/otext.png}
\end{center}
...
\begin{center}
  \includegraphics[width=12cm]{../Slides/img/otext2.png}
\end{center}
...
\begin{center}
  \includegraphics[width=12cm]{../Slides/img/oplot.png}
\end{center}
...
\begin{center}
  \includegraphics[width=12cm]{../Slides/img/otable.png}
\end{center}
...
\begin{center}
  \includegraphics[width=14cm]{../Slides/img/odatable.png}
\end{center}

## Définir des élements de l'interface côté serveur

Dans certains cas, on souhaite définir des inputs ou des structures côté serveur (e.g., créer un input dépendant d'un fichier utilisateur, lister les colonnes d'un jeu de données). Cela est possible avec les fonctions ``uiOutput`` et ``renderUI``.
...
\begin{center}
  \includegraphics[width=14cm]{../Slides/img/ui_output.png}
\end{center}
...
\begin{center}
  \includegraphics[width=14cm]{../Slides/img/single_app.png}
\end{center}
...
\begin{center}
  \includegraphics[width=14cm]{../Slides/img/dual_apps.png}
\end{center}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{../Slides/img/html_apps.png}
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{../Slides/img/more_apps.png}
...
\begin{center}
  \includegraphics[width=14cm]{../Slides/img/sidabar.png}
\end{center}
...
\begin{center}
  \includegraphics[width=14cm]{../Slides/img/wellPanel.png}
\end{center}
...
\begin{center}
  \includegraphics[width=14cm]{../Slides/img/navbar.png}
\end{center}
...
\begin{center}
  \includegraphics[width=14cm]{../Slides/img/tabpanel.png}
\end{center}
...
\begin{center}
  \includegraphics[width=14cm]{../Slides/img/grid.png}
\end{center}
...
\begin{center}
  \includegraphics[width=14cm]{../Slides/img/tags.png}
\end{center}
...
\begin{center}
  \includegraphics[width=12cm]{../Slides/img/struct.png}
\end{center}
...
\begin{center}
  \includegraphics[width=10cm]{../Slides/img/dash.png}
\end{center}
...
On peut aussi utiliser complètement un fichier __CSS__ externe (e.g., voir figure~\ref{superhero}). Dans ce cas, il y a deux façons d'y faire appel: 
...
\begin{figure}
  \centering
  \includegraphics[width=12cm]{../Slides/img/css1.png}
  \caption{Exemple du thème \emph{superhero}. Beaucoup d'autres sont disponibles à l'adresse http://bootswatch.com.\label{superhero}}
\end{figure}
...
\begin{center}
  \includegraphics[width=10cm]{../Slides/img/css2.png}
\end{center}
...
\begin{center}
  \includegraphics[width=10cm]{../Slides/img/css3.png}
\end{center}
...
\begin{center}
  \includegraphics[width=12cm]{../Slides/img/dygraphs.png}
\end{center}

\begin{center}
  \includegraphics[width=12cm]{../Slides/img/leaflet.png}
\end{center}

\begin{center}
  \includegraphics[width=12cm]{../Slides/img/ramcharts.png}
\end{center}

\begin{center}
  \includegraphics[width=12cm]{../Slides/img/visnetwork.png}
\end{center}

\begin{center}
  \includegraphics[width=12cm]{../Slides/img/ggvis.png}
\end{center}
...
\begin{center}
  \includegraphics[width=12cm]{../Slides/img/isolation.png}
\end{center}
...
\begin{center}
  \includegraphics[width=12cm]{../Slides/img/RV.png}
\end{center}
...
\begin{center}
  \includegraphics[width=14cm]{../Slides/img/observer1.png}
\end{center}

\begin{center}
  \includegraphics[width=14cm]{../Slides/img/observer2.png}
\end{center}
...
\begin{center}
  \includegraphics[width=12cm]{../Slides/img/cond1.png}
\end{center}
...
Un des premiers niveaux de débogage est l'utilisation de _`print console`_ au sein de l'application shiny. Cela permet d'afficher des informations lors du développement et/ou de l'exécution de l'application. C'est un peu déconseillé car il est parfois difficile et souvent laborieux de les supprimer à la fin du développement. De plus, dans __shiny__ on utilisera de préférence ``cat(file=stderr(), ...)`` pour être sûr que l'affichage marche dans tous les cas d'outputs, et également dans les logs avec __shiny-server__.
...
\begin{center}
\includegraphics[width=12cm]{../Slides/img/debug_cheat.png}
\end{center}
...
![](../Slides/img/debug_showcase.png)

## Reactive log

En activant l'option ``shiny.reactlog``, on peut visualiser à tout instant les dépendances et les flux entre les objets réactifs de __shiny__ :
...
![](../Slides/img/debug_stack.png)

# Conclusion

## Quelques bonnes pratiques

- Préférer l'underscore au point comme séparateur dans le nom des variables (e.g., `ma_variable` est préférable à `ma.variable`). En effet, le point peut amener de mauvaises intéractions avec d'autres langages, comme le __JavaScript__;
